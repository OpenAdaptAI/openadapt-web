...
// All GitHub data is fetched here, at build/revalidate time, inside
// getStaticProps (dynamic import only — keep this module out of client
// bundles).
//
// An optional GITHUB_TOKEN environment variable raises the rate limit for
// builds. It is never required (builds are few, unauthenticated is fine)
