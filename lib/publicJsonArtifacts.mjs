...
export const PUBLIC_JSON_ARTIFACTS = Object.freeze({
    ...
    '/business-decision/provenance.json': Object.freeze({
        ...
        sha256: '5eaab49ac717f24746ddb58c8cca75c252bc6ba7c1e1440b56e482a975f26857',
    }),
    ...
    '/media/openemr/provenance.json': Object.freeze({
        source: '/media/openemr/provenance.json',
        fileName: 'provenance.json',
        format: 'json',
        title: 'OpenEMR governed-run film provenance',
        description:
            'Approved-egress content hashes, caption derivation, and disclosures for the OpenEMR governed-run film on the Execute page.',
        sha256: '02ef93ed214fab373fcda5b876a25e432ac34081ca722495e4601c5c04394b6a',
    }),
