...
const LAUNCH_PRICE_DISPLAY = '$500.00'
const LAUNCH_PRICE_CADENCE = '/month'
...
function hostedOfferFromPrice(price, { expectedLive } = {}) {
    ...
    // Price, product, cadence, and allowance form one launch offer. Public
    // pages may display the code-owned launch terms, but checkout stays
    // unavailable unless this exact live provider contract is verified.
    if (
