 ...
 * Server-only (lives in lib/ so client bundles never construct GitHub API
 * requests). Used by:
 ...
 * Runs server-side only; unauthenticated works (60 req/hr limit, fine with
 * the 24h cache), and an optional GITHUB_TOKEN raises the limit.
